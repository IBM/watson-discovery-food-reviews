...
const PRODUCT_DATA_INDEX     = 5;
const REVIEWER_DATA_INDEX    = 6;
//const SENTIMENT_DATA_INDEX   = 5;
...
const SENTIMENT_TERM_ITEM = 'All Terms';   // used to indicate no specific item is selected
const TRENDING_TERM_ITEM = 'Select Term';  // used to indicate no specific item is selected

// filter types and strings to use
const filterTypes = [
  { key: PRODUCT_FILTER,      value: PRODUCT_FILTER,     text: 'Products'},
  { key: REVIEWER_FILTER,     value: REVIEWER_FILTER,    text: 'Reviewer'},
  { key: SENTIMENT_FILTER,    value: SENTIMENT_FILTER,   text: 'Sentiment'},
